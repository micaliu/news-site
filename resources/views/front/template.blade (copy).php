...
<html lang="{{ config('app.locale') }}">
  ...
  <body>
    ...
    <header>
        <div id="headerbar" style="height: 60px;">
          <div class="container headerbarin" style="height: 60px;">
            <div class="h_date  h_date1 pull-left" style="height: 60px;">
              <p>Friday, Dec 23, 2016</p><p> 
                            </p><div class=" show_small sub_search pull-right">
              ...
              <div class="navbar-header">
                <button type="button" class="navbar-toggle menu_showb" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="true">
         ...
         <span class="show_small">menu</span>
            ...
            <div id="logo"> <a class="navbar-brand" href="/"><img src="http://www.olivetnews.com/images/logo_news.png" alt=""></a></div>
            <div class="gohome pull-right">
              <a href="http://olivetuniversity.edu"><img src="http://www.olivetnews.com/images/logo_ou.png" alt=""><span>Home</span></a>
            </div>
          </div>
        </div>
<!--         <div class="brand">{{ trans('front/site.title') }}</div>
    ...
    {!! HTML::script('js/jquery.disables.scroll.js') !!}
