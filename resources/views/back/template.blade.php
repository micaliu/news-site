...
<!--                             <li {!! classActivePath('contact') !!}>
                            ...
                            <li {!! classActivePath('sections') !!}>
                                <a href="#" data-toggle="collapse" data-target="#sectionsmenu"><span class="fa fa-fw fa-envelope"></span> {{ trans('back/admin.sections') }} <span class="fa fa-fw fa-caret-down"></span></a>
                                <ul id="sectionsmenu" class="collapse">
                                    <li><a href="{!! url('section') !!}">{{ trans('back/admin.see-all') }}</a></li>
                                    <li><a href="{!! url('section/create') !!}">{{ trans('back/admin.add') }}</a></li>
                                </ul>
